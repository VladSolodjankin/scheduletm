...
### Текущий MVP scope (статус)
  ...
  - диалог create/edit appointment использует двухколоночную компоновку полей на `sm+`, а блок выбора времени расположен перед блоком контактных данных клиента.

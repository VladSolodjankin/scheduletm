...
Этот документ фиксирует текущий продуктовый контракт. Новые providers не входят
в production MVP без отдельного продуктового решения; общий backlog находится в
[`../TODO.md`](../TODO.md).

...
- Account settings API includes offline business location foundation fields: `businessAddress`, `businessLat`, `businessLng` (for upcoming Mapbox-based offline meeting location flow).

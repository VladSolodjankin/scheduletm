export const dictionaries = {
  en: {
    ...
    publicPageBuilder: {
      ...
      fieldTitle: 'Title', fieldSubtitle: 'Subtitle', fieldBody: 'Text', fieldDescription: 'Description',
      ...
      tabContent: 'Content', tabSettings: 'Settings', tabSection: 'Section', fieldLayout: 'Layout',
      avatarLayoutCentered: 'Centered', avatarLayoutImageLeft: 'Image left', avatarLayoutImageRight: 'Image right', avatarLayoutCompact: 'Compact',
      ...
      image: 'Image', addImage: 'Add image',
  ...
  ru: {
    ...
    publicPageBuilder: {
      ...
      fieldTitle: 'Заголовок', fieldSubtitle: 'Подзаголовок', fieldBody: 'Текст', fieldDescription: 'Описание',
      ...
      platformInstagram: 'Instagram', platformTelegram: 'Telegram', platformWhatsapp: 'WhatsApp', platformViber: 'Viber',
      platformFacebook: 'Facebook', platformThreads: 'Threads', platformTiktok: 'TikTok',
      tabContent: 'Содержимое', tabSettings: 'Настройки', tabSection: 'Секция', fieldLayout: 'Расположение',
      avatarLayoutCentered: 'По центру', avatarLayoutImageLeft: 'Фото слева', avatarLayoutImageRight: 'Фото справа', avatarLayoutCompact: 'Компактно',
      ...
      image: 'Изображение', addImage: 'Добавить изображение',
    }
  }
} as const;

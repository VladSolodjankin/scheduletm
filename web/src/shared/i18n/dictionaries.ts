export const dictionaries = {
  en: {
    ...
    publicPageBuilder: {
      ...
      blockTypeHero: 'Hero', blockTypeLinks: 'Links', blockTypeText: 'Text', blockTypeImage: 'Image',
      ...
      fieldLabel: 'Link text', fieldUrl: 'URL', fieldImageUrl: 'Image URL', fieldCtaLabel: 'Button text',
      fieldAddress: 'Address', fieldPrice: 'Price', fieldPlatform: 'Platform', fieldValue: 'Value',
      fieldAction: 'Button action', fieldPhone: 'Phone number', fieldEmail: 'Email',
  ...
  ru: {
    ...
    publicPageBuilder: {
      ...
      blockTypeHero: 'Главный экран', blockTypeLinks: 'Ссылки', blockTypeText: 'Текст', blockTypeImage: 'Изображение',
      ...
      fieldLabel: 'Текст ссылки', fieldUrl: 'URL', fieldImageUrl: 'URL изображения', fieldCtaLabel: 'Текст кнопки',
      fieldAddress: 'Адрес', fieldPrice: 'Цена', fieldPlatform: 'Платформа', fieldValue: 'Значение',
      fieldAction: 'Действие кнопки', fieldPhone: 'Телефон', fieldEmail: 'Email',

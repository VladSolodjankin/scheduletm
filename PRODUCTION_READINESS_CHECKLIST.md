...
- Регистрация
- Логин
- Странца настроек приложения/telegram бота/настройка оповещений/настройка специалистов/настройка users/настройка услуг/настройка аккаунта (можно все сделать на одной странице settings и просто добавить Tabs)
- Добавить поддержку разных языков (файлы с переводами лучше будет разнести по страницам)
- Добавить управление appointments (сммена статуса, подтверждение оплаты, отмена записи, изменить дату, отправить оповещение в ручную, добавление ссылки для встречи)
